# Minimalist C++ Software Renderer
...
Для сборки требуется **CMake**, компилятор C++ (Clang/GCC/MSVC) и установленные зависимости (включены в репозиторий или требуют установки: GLFW, OpenGL).

bash

`# 1. Клонирование репозитория git clone https://github.com/your-username/your-repo.git cd your-repo # 2. Создание папки сборки mkdir build cd build # 3. Конфигурация и сборка cmake .. make # 4. Запуск ./app`
